    ...
    switch ($act) {
        ...
        case 'addsubcategory':
            ...
            if (isset($_POST['add_subCategory'])) {
                ...
                $subcat_code = $_POST['subcat_code'];
                $subcat_description = $_POST['subcat_description'];

                createSubCatelogy($subcat_catelogy, $subcat_name, $subcat_code, $subcat_description);
        ...
        case 'updatesubcategory':
            if (isset($_GET['subCat_id'])) {
                ...
                if (isset($_POST['update_subCategory'])) {
                    ...
                    updateSubCatelogy($subCat_id,$subcat_catelogy, $subcat_name, $subcat_code, $subcat_description);
