<div class="sma-right">
  <div class="sma-r-top">
    <div class="sma-rt-left">
      <div class="sma-rt-l-title eh6">Blog List</div>
    ...
    <table class="table sma-rb-bot">
      <thead class="sma-rb-b-heading">
        <tr>
          ...
          <th class="sma-rb-bh-title eh">Blog Title</th>
          <th class="sma-rb-bh-title eh">Blog Content</th>
          <th class="sma-rb-bh-title eh">Created</th>
          <th class="sma-rb-bh-title eh">Action</th>
        </tr>
      </thead>
      <?php foreach ($show_blogs as $blog) : ?>
        <tbody class="sma-rb-b-ite ms blog">
          <tr class="sma-rb-b-item">
            ...
            <td class="sma-rb-bi image">
              <div class="sma-rb-bi-img">
                <img src="assets/images/<?= $blog['BlogImage'] ?>" width="40" height="40" alt="" />
              </div>
            </td>
            <td class="sma-rb-bi title"><div><p id="blog-fix"><?= $blog['BlogTitle'] ?></p></div></td>
            <td class="sma-rb-bi content"><div><p id="blog-fix"><?= $blog['BlogContent'] ?></p></div></td>
            <td class="sma-rb-bi create"><div>Admin</div></td>
            <td class="sma-rb-bi action">
              <div class="sma-rb-bi-show">
                <i class="uil uil-eye"></i>
              </div>
              <a href="?mod=blog&act=updateblog&blog_id=<?= $blog['id'] ?>">
                <div class="sma-rb-bi-edit">
                  <i class="uil uil-edit-alt"></i>
                </div>
              </a>
              <a href="?mod=blog&act=deleteblog&blog_id=<?= $blog['id'] ?>">
